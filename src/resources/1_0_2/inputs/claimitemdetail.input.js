...
const { GraphQLInputObjectType, GraphQLNonNull, GraphQLFloat, GraphQLList } = require('graphql');
...
/**
 * @name exports
 * @summary Claim.item.detail Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'ClaimItemDetail_Input',
	...
	fields: () => extendSchema(require('./backboneelement.input'), {
		...
		subDetail: {
			type: new GraphQLList(require('./claimitemdetailsubdetail.input')),
