...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => extendSchema(require('./domainresource.input'), {
		...
		contact: {
			type: new GraphQLList(require('./implementationguidecontact.input')),
		...
		package: {
			type: new GraphQLList(new GraphQLNonNull(require('./implementationguidepackage.input'))),
		...
		page: {
			type: new GraphQLNonNull(require('./implementationguidepage.input')),
