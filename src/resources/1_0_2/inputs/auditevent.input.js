...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => ({
		...
		event: {
			type: new GraphQLNonNull(require('./auditeventevent.input.js')),
			description:
				'Identifies the name, action type, time, and disposition of the audited event.',
		},
		participant: {
			type: new GraphQLList(
				new GraphQLNonNull(require('./auditeventparticipant.input.js')),
			),
		...
		object: {
			type: new GraphQLList(require('./auditeventobject.input.js')),
			description:
