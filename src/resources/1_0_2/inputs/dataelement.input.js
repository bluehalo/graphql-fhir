...
module.exports = new GraphQLInputObjectType({
	...
	fields: () =>
		extendSchema(require('./domainresource.input'), {
			resourceType: {
				type: new GraphQLNonNull(DataElementResourceInputType),
			...
			contact: {
				type: new GraphQLList(require('./dataelementcontact.input')),
				description:
			...
			mapping: {
				type: new GraphQLList(require('./dataelementmapping.input')),
				description:
