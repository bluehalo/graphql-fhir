	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'PaymentReconciliation_Enum_input',
		...
		detail: {
			type: new GraphQLList(require('./paymentreconciliationdetail.input.js')),
			description:
		...
		note: {
			type: new GraphQLList(require('./paymentreconciliationnote.input.js')),
