...
module.exports = {
	requester: {
		type: GraphQLString,
		description: 'Requester of referral / transfer of care (See http://hl7.org/fhir/SearchParameter/referralrequest-requester).'
	},
	patient: {
		type: GraphQLString,
		description: 'Who the referral is about (See http://hl7.org/fhir/SearchParameter/referralrequest-patient).'
	},
	status: {
		type: TokenScalar,
	...
	type: {
		type: TokenScalar,
		description: 'The type of the referral (See http://hl7.org/fhir/SearchParameter/referralrequest-type).'
	},
	date: {
		type: DateScalar,
		description: 'Creation or activation date (See http://hl7.org/fhir/SearchParameter/referralrequest-date).'
	},
	specialty: {
		type: TokenScalar,
