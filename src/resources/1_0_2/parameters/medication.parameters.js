...
module.exports = {
	content: {
		type: GraphQLString,
		description: 'A product in the package. See http://hl7.org/fhir/SearchParameter/medication-content.'
	},
	form: {
		type: TokenScalar,
		description: 'powder | tablets | carton +. See http://hl7.org/fhir/SearchParameter/medication-form.'
	},
	container: {
		type: TokenScalar,
	...
	code: {
		type: TokenScalar,
		description: 'Codes that identify this medication. See http://hl7.org/fhir/SearchParameter/medication-code.'
	}
};
