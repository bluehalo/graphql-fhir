...
module.exports = {
	servicecategory: {
		type: TokenScalar,
		description:
			'Service Category of the Healthcare Service (See http://hl7.org/fhir/SearchParameter/healthcareservice-servicecategory).',
	},
	organization: {
		type: GraphQLString,
		description:
	...
	servicetype: {
		type: TokenScalar,
		description:
			'The type of service provided by this healthcare service (See http://hl7.org/fhir/SearchParameter/healthcareservice-servicetype).',
	},
	location: {
		type: GraphQLString,
		description:
