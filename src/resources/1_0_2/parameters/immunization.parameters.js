...
module.exports = {
	...
	requester: {
		type: GraphQLString,
		description: 'The practitioner who ordered the vaccination. See http://hl7.org/fhir/SearchParameter/immunization-requester.'
	},
	dose_sequence: {
		type: GraphQLString,
	...
	date: {
		type: DateScalar,
		description: 'Vaccination  (non)-Administration Date. See http://hl7.org/fhir/SearchParameter/immunization-date.'
	},
	reason_not_given: {
		type: TokenScalar,
	...
	patient: {
		type: GraphQLString,
		description: 'The patient for the vaccination record. See http://hl7.org/fhir/SearchParameter/immunization-patient.'
	},
	lot_number: {
		type: GraphQLString,
	...
	performer: {
		type: GraphQLString,
		description: 'The practitioner who administered the vaccination. See http://hl7.org/fhir/SearchParameter/immunization-performer.'
	},
	identifier: {
		type: TokenScalar,
		description: 'Business identifier. See http://hl7.org/fhir/SearchParameter/immunization-identifier.'
	}
};
