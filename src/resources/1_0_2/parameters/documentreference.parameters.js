...
module.exports = {
	...
	indexed: {
		type: DateScalar,
		description:
			'When this document reference created (See http://hl7.org/fhir/SearchParameter/documentreference-indexed).',
	},
	location: {
		type: UriScalar,
		description:
	...
	encounter: {
		type: GraphQLString,
		description:
			'Context of the document  content (See http://hl7.org/fhir/SearchParameter/documentreference-encounter).',
	},
	type: {
		type: TokenScalar,
		description:
			'Kind of document (LOINC if possible) (See http://hl7.org/fhir/SearchParameter/documentreference-type).',
	},
	securitylabel: {
		type: TokenScalar,
		description:
	...
	patient: {
		type: GraphQLString,
		description:
			'Who/what is the subject of the document (See http://hl7.org/fhir/SearchParameter/documentreference-patient).',
	},
	facility: {
		type: TokenScalar,
		description:
	...
	identifier: {
		type: TokenScalar,
		description:
			'Master Version Specific Identifier (See http://hl7.org/fhir/SearchParameter/documentreference-identifier).',
	},
};
