...
/**
 * @name exports
 * @summary ClaimResponsecoverage Schema
 */
module.exports = new GraphQLObjectType({
	name: 'ClaimResponsecoverage',
	description: '',
	fields: () => ({
		_id: {
		...
		coverage: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'ClaimResponsecoveragecoverage_coverage_Union',
					description:
		...
		claimResponse: {
			type: new GraphQLUnionType({
				name: 'ClaimResponsecoverageclaimResponse_claimResponse_Union',
