	...
	fields: () => ({
		...
		request: {
			type: new GraphQLUnionType({
				name: 'ExplanationOfBenefitrequest_request_Union',
		...
		requestProvider: {
			type: new GraphQLUnionType({
				name: 'ExplanationOfBenefitrequestProvider_requestProvider_Union',
				description:
		...
		requestOrganization: {
			type: new GraphQLUnionType({
				name: 'ExplanationOfBenefitrequestOrganization_requestOrganization_Union',
				description:
