...
let ConformanceResourceType = new GraphQLEnumType({
...
module.exports = new GraphQLObjectType({
	...
	fields: () => extendSchema(require('./domainresource.schema'), {
		resourceType: {
			type: new GraphQLNonNull(ConformanceResourceType),
		...
		contact: {
			type: new GraphQLList(require('./conformancecontact.schema')),
		...
		software: {
			type: require('./conformancesoftware.schema'),
		...
		implementation: {
			type: require('./conformanceimplementation.schema'),
		...
		rest: {
			type: new GraphQLList(require('./conformancerest.schema')),
			description: 'A definition of the restful capabilities of the solution, if any.'
		},
		messaging: {
			type: new GraphQLList(require('./conformancemessaging.schema')),
			description: 'A description of the messaging capabilities of the solution.'
		},
		document: {
			type: new GraphQLList(require('./conformancedocument.schema')),
