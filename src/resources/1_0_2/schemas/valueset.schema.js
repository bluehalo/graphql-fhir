...
module.exports = new GraphQLObjectType({
	...
	fields: () => ({
		...
		contact: {
			type: new GraphQLList(require('./valuesetcontact.schema.js')),
			description:
		...
		codeSystem: {
			type: require('./valuesetcodesystem.schema.js'),
			description:
		...
		compose: {
			type: require('./valuesetcompose.schema.js'),
			description:
		...
		expansion: {
			type: require('./valuesetexpansion.schema.js'),
			description:
