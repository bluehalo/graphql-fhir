...
let MedicationOrderResourceType = new GraphQLEnumType({
	name: 'MedicationOrderResourceType',
	values: {
...
module.exports = new GraphQLObjectType({
	...
	fields: () =>
		extendSchema(require('./domainresource.schema'), {
			resourceType: {
				type: new GraphQLNonNull(MedicationOrderResourceType),
			...
			dosageInstruction: {
				type: new GraphQLList(
					require('./medicationorderdosageinstruction.schema'),
				),
				description:
