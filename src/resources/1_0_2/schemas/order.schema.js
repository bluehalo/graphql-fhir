	...
	fields: () => ({
		...
		subject: {
			type: new GraphQLUnionType({
				name: 'Ordersubject_subject_Union',
		...
		reasonReference: {
			type: new GraphQLUnionType({
				name: 'OrderreasonReference_reasonReference_Union',
				description: 'Text - why the order was made.',
		...
		when: {
			type: require('./orderwhen.schema.js'),
