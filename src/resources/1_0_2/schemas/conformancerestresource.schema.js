...
const { GraphQLObjectType, GraphQLNonNull, GraphQLList, GraphQLBoolean, GraphQLString } = require('graphql');
...
module.exports = new GraphQLObjectType({
	...
	fields: () => extendSchema(require('./backboneelement.schema'), {
		...
		searchParam: {
			type: new GraphQLList(require('./conformancerestresourcesearchparam.schema')),
