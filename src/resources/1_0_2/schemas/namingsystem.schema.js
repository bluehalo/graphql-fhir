...
module.exports = new GraphQLObjectType({
	...
	fields: () => ({
		...
		contact: {
			type: new GraphQLList(require('./namingsystemcontact.schema.js')),
			description:
		...
		uniqueId: {
			type: new GraphQLList(
				new GraphQLNonNull(require('./namingsystemuniqueid.schema.js')),
			),
			description:
		...
		replacedBy: {
			type: new GraphQLUnionType({
				name: 'NamingSystemreplacedBy_replacedBy_Union',
				description:
					'For naming systems that are retired, indicates the naming system that should be used in their place (if any).',
				types: () => [require('./namingsystem.schema.js')],
				resolveType(data) {
