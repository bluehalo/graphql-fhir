	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					...
					values: { VisionPrescription: { value: 'VisionPrescription' } },
				}),
			),
		...
		patient: {
			type: new GraphQLUnionType({
				name: 'VisionPrescriptionpatient_patient_Union',
				description:
		...
		prescriber: {
			type: new GraphQLUnionType({
				name: 'VisionPrescriptionprescriber_prescriber_Union',
				description:
		...
		encounter: {
			type: new GraphQLUnionType({
				name: 'VisionPrescriptionencounter_encounter_Union',
				description:
		...
		reasonReference: {
			type: new GraphQLUnionType({
				name: 'VisionPrescriptionreasonReference_reasonReference_Union',
				description:
					'Can be the reason or the indication for writing the prescription.',
		...
		dispense: {
			type: new GraphQLList(require('./visionprescriptiondispense.schema.js')),
			description:
