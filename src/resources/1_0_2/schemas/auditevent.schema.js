...
module.exports = new GraphQLObjectType({
	...
	fields: () => ({
		...
		event: {
			type: new GraphQLNonNull(require('./auditeventevent.schema.js')),
			description:
				'Identifies the name, action type, time, and disposition of the audited event.',
		},
		participant: {
			type: new GraphQLList(
				new GraphQLNonNull(require('./auditeventparticipant.schema.js')),
			),
		...
		object: {
			type: new GraphQLList(require('./auditeventobject.schema.js')),
			description:
