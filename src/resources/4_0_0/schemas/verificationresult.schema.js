	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'VerificationResult_Enum_schema',
		...
		target: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'VerificationResulttarget_target_Union',
		...
		primarySource: {
			type: new GraphQLList(
				require('./verificationresultprimarysource.schema.js'),
			),
			description:
				'Information about the primary source(s) involved in validation.',
		},
		attestation: {
			type: require('./verificationresultattestation.schema.js'),
			description: 'Information about the entity attesting to information.',
		},
		validator: {
			type: new GraphQLList(require('./verificationresultvalidator.schema.js')),
