	...
	fields: () => ({
		...
		patient: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'ImmunizationRecommendationpatient_patient_Union',
		...
		authority: {
			type: new GraphQLUnionType({
				name: 'ImmunizationRecommendationauthority_authority_Union',
				description:
		...
		recommendation: {
			type: new GraphQLList(
				new GraphQLNonNull(
					require('./immunizationrecommendationrecommendation.schema.js'),
				),
			),
