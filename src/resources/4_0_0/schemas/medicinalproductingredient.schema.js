...
/**
 * @name exports
 * @summary MedicinalProductIngredient Schema
 */
module.exports = new GraphQLObjectType({
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					...
					values: {
						MedicinalProductIngredient: { value: 'MedicinalProductIngredient' },
					},
				}),
			),
		...
		manufacturer: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'MedicinalProductIngredientmanufacturer_manufacturer_Union',
		...
		specifiedSubstance: {
			type: new GraphQLList(
				require('./medicinalproductingredientspecifiedsubstance.schema.js'),
			),
			description: 'A specified substance that comprises this ingredient.',
		},
		substance: {
			type: require('./medicinalproductingredientsubstance.schema.js'),
