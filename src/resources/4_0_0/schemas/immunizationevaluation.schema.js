...
/**
 * @name exports
 * @summary ImmunizationEvaluation Schema
 */
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'ImmunizationEvaluation_Enum_schema',
					values: {
						ImmunizationEvaluation: { value: 'ImmunizationEvaluation' },
					},
				}),
			),
		...
		patient: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'ImmunizationEvaluationpatient_patient_Union',
		...
		authority: {
			type: new GraphQLUnionType({
				name: 'ImmunizationEvaluationauthority_authority_Union',
				description:
