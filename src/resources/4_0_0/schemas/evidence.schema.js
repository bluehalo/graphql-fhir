	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'Evidence_Enum_schema',
					values: { Evidence: { value: 'Evidence' } },
				}),
			),
		...
		exposureBackground: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'EvidenceexposureBackground_exposureBackground_Union',
					description:
		...
		exposureVariant: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'EvidenceexposureVariant_exposureVariant_Union',
					description:
		...
		outcome: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'Evidenceoutcome_outcome_Union',
					description:
