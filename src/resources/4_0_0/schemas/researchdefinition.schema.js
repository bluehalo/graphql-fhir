...
/**
 * @name exports
 * @summary ResearchDefinition Schema
 */
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'ResearchDefinition_Enum_schema',
		...
		subjectReference: {
			type: new GraphQLUnionType({
				name: 'ResearchDefinitionsubjectReference_subjectReference_Union',
				description:
					'The intended subjects for the ResearchDefinition. If this element is not provided, a Patient subject is assumed, but the subject of the ResearchDefinition can be anything.',
		...
		population: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'ResearchDefinitionpopulation_population_Union',
					description:
						'A reference to a ResearchElementDefinition resource that defines the population for the research.',
					types: () => [require('./researchelementdefinition.schema.js')],
					resolveType(data) {
		...
		exposure: {
			type: new GraphQLUnionType({
				name: 'ResearchDefinitionexposure_exposure_Union',
				description:
		...
		exposureAlternative: {
			type: new GraphQLUnionType({
				name: 'ResearchDefinitionexposureAlternative_exposureAlternative_Union',
				description:
		...
		outcome: {
			type: new GraphQLUnionType({
				name: 'ResearchDefinitionoutcome_outcome_Union',
				description:
