...
/**
 * @name exports
 * @summary MedicinalProductContraindicationotherTherapy Schema
 */
		...
		medicationReference: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'MedicinalProductContraindicationotherTherapymedicationReference_medicationReference_Union',
					description:
						'Reference to a specific medication (active substance, medicinal product or class of products) as part of an indication or contraindication.',
					types: () => [
