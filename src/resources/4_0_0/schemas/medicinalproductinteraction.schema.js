...
/**
 * @name exports
 * @summary MedicinalProductInteraction Schema
 */
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'MedicinalProductInteraction_Enum_schema',
					values: {
		...
		subject: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'MedicinalProductInteractionsubject_subject_Union',
					description:
		...
		interactant: {
			type: new GraphQLList(
				require('./medicinalproductinteractioninteractant.schema.js'),
			),
			description:
