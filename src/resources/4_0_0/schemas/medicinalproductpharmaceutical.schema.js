...
/**
 * @name exports
 * @summary MedicinalProductPharmaceutical Schema
 */
module.exports = new GraphQLObjectType({
	...
	fields: () => ({
		...
		ingredient: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'MedicinalProductPharmaceuticalingredient_ingredient_Union',
					description: 'Ingredient.',
					types: () => [require('./medicinalproductingredient.schema.js')],
					resolveType(data) {
		...
		device: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'MedicinalProductPharmaceuticaldevice_device_Union',
		...
		characteristics: {
			type: new GraphQLList(
				require('./medicinalproductpharmaceuticalcharacteristics.schema.js'),
			),
		...
		routeOfAdministration: {
			type: new GraphQLList(
				new GraphQLNonNull(
					require('./medicinalproductpharmaceuticalrouteofadministration.schema.js'),
				),
			),
			description:
