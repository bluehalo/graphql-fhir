...
/**
 * @name exports
 * @summary ExplanationOfBenefititemdetail Schema
 */
module.exports = new GraphQLObjectType({
	...
	fields: () => ({
		...
		udi: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'ExplanationOfBenefititemdetailudi_udi_Union',
					description:
		...
		subDetail: {
			type: new GraphQLList(
				require('./explanationofbenefititemdetailsubdetail.schema.js'),
			),
