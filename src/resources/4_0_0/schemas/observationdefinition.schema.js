...
/**
 * @name exports
 * @summary ObservationDefinition Schema
 */
module.exports = new GraphQLObjectType({
	...
	fields: () => ({
		...
		quantitativeDetails: {
			type: require('./observationdefinitionquantitativedetails.schema.js'),
			description:
				'Characteristics for quantitative results of this observation.',
		},
		qualifiedInterval: {
			type: new GraphQLList(
				require('./observationdefinitionqualifiedinterval.schema.js'),
			),
			description:
