	...
	fields: () => ({
		...
		subjectReference: {
			type: new GraphQLUnionType({
				name: 'MeasuresubjectReference_subjectReference_Union',
				description:
					'The intended subjects for the measure. If this element is not provided, a Patient subject is assumed, but the subject of the measure can be anything.',
		...
		group: {
			type: new GraphQLList(require('./measuregroup.schema.js')),
			description: 'A group of population criteria for the measure.',
		},
		supplementalData: {
			type: new GraphQLList(require('./measuresupplementaldata.schema.js')),
			description:
