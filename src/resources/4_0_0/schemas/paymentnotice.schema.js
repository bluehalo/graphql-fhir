...
module.exports = new GraphQLObjectType({
	...
	fields: () => ({
		...
		payment: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'PaymentNoticepayment_payment_Union',
					description:
						'A reference to the payment which is the subject of this notice.',
					types: () => [require('./paymentreconciliation.schema.js')],
					resolveType(data) {
		...
		payee: {
			type: new GraphQLUnionType({
				name: 'PaymentNoticepayee_payee_Union',
				description:
		...
		recipient: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'PaymentNoticerecipient_recipient_Union',
