...
/**
 * @name exports
 * @summary EventDefinition Schema
 */
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'EventDefinition_Enum_schema',
		...
		subjectReference: {
			type: new GraphQLUnionType({
				name: 'EventDefinitionsubjectReference_subjectReference_Union',
				description:
					'A code or group definition that describes the intended subject of the event definition.',
		...
		trigger: {
			type: new GraphQLList(
				new GraphQLNonNull(require('./triggerdefinition.schema.js')),
			),
			description:
