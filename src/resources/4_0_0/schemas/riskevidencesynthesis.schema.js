...
/**
 * @name exports
 * @summary RiskEvidenceSynthesis Schema
 */
	...
	fields: () => ({
		...
		population: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'RiskEvidenceSynthesispopulation_population_Union',
					description:
		...
		exposure: {
			type: new GraphQLUnionType({
				name: 'RiskEvidenceSynthesisexposure_exposure_Union',
				description:
		...
		outcome: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'RiskEvidenceSynthesisoutcome_outcome_Union',
					description:
		...
		sampleSize: {
			type: require('./riskevidencesynthesissamplesize.schema.js'),
			description:
				'A description of the size of the sample involved in the synthesis.',
		},
		riskEstimate: {
			type: require('./riskevidencesynthesisriskestimate.schema.js'),
			description: 'The estimated risk of the outcome.',
		},
		certainty: {
			type: new GraphQLList(
				require('./riskevidencesynthesiscertainty.schema.js'),
			),
