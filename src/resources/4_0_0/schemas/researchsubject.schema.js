	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'ResearchSubject_Enum_schema',
		...
		study: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'ResearchSubjectstudy_study_Union',
					description:
		...
		individual: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'ResearchSubjectindividual_individual_Union',
					description:
		...
		consent: {
			type: new GraphQLUnionType({
				name: 'ResearchSubjectconsent_consent_Union',
				description:
					"A record of the patient's informed agreement to participate in the study.",
				types: () => [require('./consent.schema.js')],
				resolveType(data) {
