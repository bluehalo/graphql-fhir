...
/**
 * @name exports
 * @summary MedicinalProductManufactured Schema
 */
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'MedicinalProductManufactured_Enum_schema',
					values: {
		...
		manufacturer: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'MedicinalProductManufacturedmanufacturer_manufacturer_Union',
					description:
		...
		ingredient: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'MedicinalProductManufacturedingredient_ingredient_Union',
