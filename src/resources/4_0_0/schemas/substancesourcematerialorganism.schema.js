...
/**
 * @name exports
 * @summary SubstanceSourceMaterialorganism Schema
 */
	...
	fields: () => ({
		...
		author: {
			type: new GraphQLList(
				require('./substancesourcematerialorganismauthor.schema.js'),
			),
			description: '4.9.13.6.1 Author type (Conditional).',
		},
		hybrid: {
			type: require('./substancesourcematerialorganismhybrid.schema.js'),
			description: '4.9.13.8.1 Hybrid species maternal organism ID (Optional).',
		},
		organismGeneral: {
			type: require('./substancesourcematerialorganismorganismgeneral.schema.js'),
