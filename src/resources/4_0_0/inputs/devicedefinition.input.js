...
/**
 * @name exports
 * @summary DeviceDefinition Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'DeviceDefinition_Input',
	description:
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'DeviceDefinition_Enum_input',
		...
		udiDeviceIdentifier: {
			type: new GraphQLList(
				require('./devicedefinitionudideviceidentifier.input.js'),
			),
			description:
		...
		deviceName: {
			type: new GraphQLList(require('./devicedefinitiondevicename.input.js')),
		...
		specialization: {
			type: new GraphQLList(
				require('./devicedefinitionspecialization.input.js'),
			),
			description:
		...
		capability: {
			type: new GraphQLList(require('./devicedefinitioncapability.input.js')),
			description: 'Device capabilities.',
		},
		property: {
			type: new GraphQLList(require('./devicedefinitionproperty.input.js')),
			description:
		...
		material: {
			type: new GraphQLList(require('./devicedefinitionmaterial.input.js')),
			description:
