...
/**
 * @name exports
 * @summary BiologicallyDerivedProduct Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'BiologicallyDerivedProduct_Input',
	description:
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'BiologicallyDerivedProduct_Enum_input',
					values: {
		...
		collection: {
			type: require('./biologicallyderivedproductcollection.input.js'),
			description: 'How this product was collected.',
		},
		processing: {
			type: new GraphQLList(
				require('./biologicallyderivedproductprocessing.input.js'),
			),
			description:
				'Any processing of the product during collection that does not change the fundamental nature of the product. For example adding anti-coagulants during the collection of Peripheral Blood Stem Cells.',
		},
		manipulation: {
			type: require('./biologicallyderivedproductmanipulation.input.js'),
			description:
				'Any manipulation of product post-collection that is intended to alter the product.  For example a buffy-coat enrichment or CD8 reduction of Peripheral Blood Stem Cells to make it more suitable for infusion.',
		},
		storage: {
			type: new GraphQLList(
				require('./biologicallyderivedproductstorage.input.js'),
			),
