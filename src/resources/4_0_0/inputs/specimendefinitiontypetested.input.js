...
/**
 * @name exports
 * @summary SpecimenDefinitiontypeTested Input Schema
 */
module.exports = new GraphQLInputObjectType({
	...
	fields: () => ({
		...
		container: {
			type: require('./specimendefinitiontypetestedcontainer.input.js'),
		...
		handling: {
			type: new GraphQLList(
				require('./specimendefinitiontypetestedhandling.input.js'),
			),
			description:
