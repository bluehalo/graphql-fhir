...
/**
 * @name exports
 * @summary RiskEvidenceSynthesiscertainty Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'RiskEvidenceSynthesiscertainty_Input',
	description: '',
	fields: () => ({
		_id: {
		...
		certaintySubcomponent: {
			type: new GraphQLList(
				require('./riskevidencesynthesiscertaintycertaintysubcomponent.input.js'),
			),
