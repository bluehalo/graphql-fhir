...
/**
 * @name exports
 * @summary MedicinalProductInteraction Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'MedicinalProductInteraction_Input',
	description:
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'MedicinalProductInteraction_Enum_input',
					values: {
		...
		interactant: {
			type: new GraphQLList(
				require('./medicinalproductinteractioninteractant.input.js'),
			),
			description:
