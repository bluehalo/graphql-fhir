...
/**
 * @name exports
 * @summary TerminologyCapabilities Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'TerminologyCapabilities_Input',
	description:
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'TerminologyCapabilities_Enum_input',
					values: {
		...
		software: {
			type: require('./terminologycapabilitiessoftware.input.js'),
			description:
				'Software that is covered by this terminology capability statement.  It is used when the statement describes the capabilities of a particular software version, independent of an installation.',
		},
		implementation: {
			type: require('./terminologycapabilitiesimplementation.input.js'),
			description:
		...
		codeSystem: {
			type: new GraphQLList(
				require('./terminologycapabilitiescodesystem.input.js'),
			),
			description:
				'Identifies a code system that is supported by the server. If there is a no code system URL, then this declares the general assumptions a client can make about support for any CodeSystem resource.',
		},
		expansion: {
			type: require('./terminologycapabilitiesexpansion.input.js'),
			description:
		...
		validateCode: {
			type: require('./terminologycapabilitiesvalidatecode.input.js'),
			description:
				'Information about the [ValueSet/$validate-code](valueset-operation-validate-code.html) operation.',
		},
		translation: {
			type: require('./terminologycapabilitiestranslation.input.js'),
			description:
				'Information about the [ConceptMap/$translate](conceptmap-operation-translate.html) operation.',
		},
		closure: {
			type: require('./terminologycapabilitiesclosure.input.js'),
