	...
	fields: () => ({
		...
		supportingInfo: {
			type: new GraphQLList(
				require('./explanationofbenefitsupportinginfo.input.js'),
			),
			description:
		...
		insurance: {
			type: new GraphQLList(
				new GraphQLNonNull(require('./explanationofbenefitinsurance.input.js')),
			),
			description:
		...
		total: {
			type: new GraphQLList(require('./explanationofbenefittotal.input.js')),
