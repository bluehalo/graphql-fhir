...
/**
 * @name exports
 * @summary SpecimenDefinition Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'SpecimenDefinition_Input',
	description: 'A kind of specimen with associated set of requirements.',
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'SpecimenDefinition_Enum_input',
					values: { SpecimenDefinition: { value: 'SpecimenDefinition' } },
				}),
			),
		...
		typeTested: {
			type: new GraphQLList(require('./specimendefinitiontypetested.input.js')),
			description:
