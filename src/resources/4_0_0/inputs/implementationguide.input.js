...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => ({
		...
		dependsOn: {
			type: new GraphQLList(require('./implementationguidedependson.input.js')),
			description:
		...
		definition: {
			type: require('./implementationguidedefinition.input.js'),
			description:
				'The information needed by an IG publisher tool to publish the whole implementation guide.',
		},
		manifest: {
			type: require('./implementationguidemanifest.input.js'),
			description:
