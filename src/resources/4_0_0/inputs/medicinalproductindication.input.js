...
/**
 * @name exports
 * @summary MedicinalProductIndication Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'MedicinalProductIndication_Input',
	description: 'Indication for the Medicinal Product.',
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'MedicinalProductIndication_Enum_input',
					values: {
		...
		otherTherapy: {
			type: new GraphQLList(
				require('./medicinalproductindicationothertherapy.input.js'),
			),
			description:
