...
/**
 * @name exports
 * @summary RiskEvidenceSynthesisriskEstimate Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'RiskEvidenceSynthesisriskEstimate_Input',
	description: '',
	fields: () => ({
		_id: {
		...
		precisionEstimate: {
			type: new GraphQLList(
				require('./riskevidencesynthesisriskestimateprecisionestimate.input.js'),
			),
			description:
