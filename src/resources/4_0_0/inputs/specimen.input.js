...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => ({
		...
		collection: {
			type: require('./specimencollection.input.js'),
			description: 'Details concerning the specimen collection.',
		},
		processing: {
			type: new GraphQLList(require('./specimenprocessing.input.js')),
			description:
				'Details concerning processing and processing steps for the specimen.',
		},
		container: {
			type: new GraphQLList(require('./specimencontainer.input.js')),
			description:
