...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => ({
		...
		participant: {
			type: new GraphQLList(require('./invoiceparticipant.input.js')),
			description:
		...
		lineItem: {
			type: new GraphQLList(require('./invoicelineitem.input.js')),
			description:
