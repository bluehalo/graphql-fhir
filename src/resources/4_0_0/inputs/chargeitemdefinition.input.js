...
/**
 * @name exports
 * @summary ChargeItemDefinition Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'ChargeItemDefinition_Input',
	description:
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'ChargeItemDefinition_Enum_input',
		...
		applicability: {
			type: new GraphQLList(
				require('./chargeitemdefinitionapplicability.input.js'),
			),
			description:
		...
		propertyGroup: {
			type: new GraphQLList(
				require('./chargeitemdefinitionpropertygroup.input.js'),
			),
			description:
