...
/**
 * @name exports
 * @summary TerminologyCapabilitiesexpansion Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'TerminologyCapabilitiesexpansion_Input',
	description: '',
	fields: () => ({
		_id: {
		...
		parameter: {
			type: new GraphQLList(
				require('./terminologycapabilitiesexpansionparameter.input.js'),
			),
