...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => ({
		...
		eligibility: {
			type: new GraphQLList(require('./healthcareserviceeligibility.input.js')),
			description:
		...
		availableTime: {
			type: new GraphQLList(
				require('./healthcareserviceavailabletime.input.js'),
			),
			description: 'A collection of times that the Service Site is available.',
		},
		notAvailable: {
			type: new GraphQLList(
				require('./healthcareservicenotavailable.input.js'),
			),
			description:
