...
/**
 * @name exports
 * @summary EvidenceVariable Input Schema
 */
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'EvidenceVariable_Enum_input',
					values: { EvidenceVariable: { value: 'EvidenceVariable' } },
				}),
			),
		...
		characteristic: {
			type: new GraphQLList(
				new GraphQLNonNull(
					require('./evidencevariablecharacteristic.input.js'),
				),
			),
			description:
