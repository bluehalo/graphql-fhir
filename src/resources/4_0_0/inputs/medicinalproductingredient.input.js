...
/**
 * @name exports
 * @summary MedicinalProductIngredient Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'MedicinalProductIngredient_Input',
	description:
	...
	fields: () => ({
		...
		specifiedSubstance: {
			type: new GraphQLList(
				require('./medicinalproductingredientspecifiedsubstance.input.js'),
			),
			description: 'A specified substance that comprises this ingredient.',
		},
		substance: {
			type: require('./medicinalproductingredientsubstance.input.js'),
