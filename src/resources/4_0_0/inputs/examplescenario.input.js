...
/**
 * @name exports
 * @summary ExampleScenario Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'ExampleScenario_Input',
	description: 'Example of workflow instance.',
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'ExampleScenario_Enum_input',
		...
		actor: {
			type: new GraphQLList(require('./examplescenarioactor.input.js')),
			description: 'Actor participating in the resource.',
		},
		instance: {
			type: new GraphQLList(require('./examplescenarioinstance.input.js')),
			description:
				'Each resource and each version that is present in the workflow.',
		},
		process: {
			type: new GraphQLList(require('./examplescenarioprocess.input.js')),
