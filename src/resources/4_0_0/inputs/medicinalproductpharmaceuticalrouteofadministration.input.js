...
/**
 * @name exports
 * @summary MedicinalProductPharmaceuticalrouteOfAdministration Input Schema
 */
	...
	fields: () => ({
		...
		targetSpecies: {
			type: new GraphQLList(
				require('./medicinalproductpharmaceuticalrouteofadministrationtargetspecies.input.js'),
			),
