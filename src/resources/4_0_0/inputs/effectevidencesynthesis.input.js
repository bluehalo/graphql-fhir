...
/**
 * @name exports
 * @summary EffectEvidenceSynthesis Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'EffectEvidenceSynthesis_Input',
	description:
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'EffectEvidenceSynthesis_Enum_input',
					values: {
		...
		sampleSize: {
			type: require('./effectevidencesynthesissamplesize.input.js'),
			description:
				'A description of the size of the sample involved in the synthesis.',
		},
		resultsByExposure: {
			type: new GraphQLList(
				require('./effectevidencesynthesisresultsbyexposure.input.js'),
			),
			description:
		...
		effectEstimate: {
			type: new GraphQLList(
				require('./effectevidencesynthesiseffectestimate.input.js'),
			),
			description: 'The estimated effect of the exposure variant.',
		},
		certainty: {
			type: new GraphQLList(
				require('./effectevidencesynthesiscertainty.input.js'),
			),
