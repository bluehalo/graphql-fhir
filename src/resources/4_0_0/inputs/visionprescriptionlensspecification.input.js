...
/**
 * @name exports
 * @summary VisionPrescriptionlensSpecification Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'VisionPrescriptionlensSpecification_Input',
	description: '',
	fields: () => ({
		_id: {
		...
		prism: {
			type: new GraphQLList(
				require('./visionprescriptionlensspecificationprism.input.js'),
			),
