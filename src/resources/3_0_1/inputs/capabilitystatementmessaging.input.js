...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => extendSchema(require('./backboneelement.input'), {
		endpoint: {
			type: new GraphQLList(require('./capabilitystatementmessagingendpoint.input')),
		...
		supportedMessage: {
			type: new GraphQLList(require('./capabilitystatementmessagingsupportedmessage.input')),
			description: 'References to message definitions for messages this system can send or receive.'
		},
		event: {
			type: new GraphQLList(require('./capabilitystatementmessagingevent.input')),
