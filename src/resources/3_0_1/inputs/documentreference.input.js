	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'DocumentReference_Enum_input',
		...
		relatesTo: {
			type: new GraphQLList(require('./documentreferencerelatesto.input.js')),
			description:
		...
		content: {
			type: new GraphQLList(
				new GraphQLNonNull(require('./documentreferencecontent.input.js')),
			),
			description:
				'The document and format referenced. There may be multiple content element repetitions, each with a different format.',
		},
		context: {
			type: require('./documentreferencecontext.input.js'),
