...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => ({
		...
		origin: {
			type: new GraphQLList(require('./testscriptorigin.input.js')),
			description:
				'An abstract server used in operations within this test script in the origin element.',
		},
		destination: {
			type: new GraphQLList(require('./testscriptdestination.input.js')),
			description:
		...
		rule: {
			type: new GraphQLList(require('./testscriptrule.input.js')),
			description:
				'Assert rule to be used in one or more asserts within the test script.',
		},
		ruleset: {
			type: new GraphQLList(require('./testscriptruleset.input.js')),
			description:
