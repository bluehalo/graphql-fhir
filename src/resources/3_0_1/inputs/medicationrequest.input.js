...
let MedicationRequestResourceInputType = new GraphQLEnumType({
	name: 'MedicationRequestResourceInputType',
	values: {
...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => extendSchema(require('./domainresource.input'), {
		resourceType: {
			type: new GraphQLNonNull(MedicationRequestResourceInputType),
		...
		requester: {
			type: require('./medicationrequestrequester.input'),
		...
		dispenseRequest: {
			type: require('./medicationrequestdispenserequest.input'),
		...
		substitution: {
			type: require('./medicationrequestsubstitution.input'),
