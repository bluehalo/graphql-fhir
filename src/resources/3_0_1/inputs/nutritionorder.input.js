	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'NutritionOrder_Enum_input',
		...
		oralDiet: {
			type: require('./nutritionorderoraldiet.input.js'),
			description: 'Diet given orally in contrast to enteral (tube) feeding.',
		},
		supplement: {
			type: new GraphQLList(require('./nutritionordersupplement.input.js')),
			description:
				"Oral nutritional products given in order to add further nutritional value to the patient's diet.",
		},
		enteralFormula: {
			type: require('./nutritionorderenteralformula.input.js'),
			description:
