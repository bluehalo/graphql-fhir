...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => extendSchema(require('./backboneelement.input'), {
		...
		interaction: {
			type: new GraphQLList(new GraphQLNonNull(require('./capabilitystatementrestresourceinteraction.input'))),
		...
		// TODO: ValueSetReference: http://hl7.org/fhir/ValueSet/conditional-read-status
		conditionalRead: {
			type: CodeScalar,
		...
		// TODO: ValueSetReference: http://hl7.org/fhir/ValueSet/reference-handling-policy
		referencePolicy: {
		...
		searchParam: {
			type: new GraphQLList(require('./capabilitystatementrestresourcesearchparam.input')),
