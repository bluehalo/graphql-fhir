...
let ExpansionProfileResourceInputType = new GraphQLEnumType({
	name: 'ExpansionProfileResourceInputType',
	values: {
...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => extendSchema(require('./domainresource.input'), {
		resourceType: {
			type: new GraphQLNonNull(ExpansionProfileResourceInputType),
		...
		fixedVersion: {
			type: new GraphQLList(require('./expansionprofilefixedversion.input')),
			description: 'Fix use of a particular code system to a particular version.'
		},
		excludedSystem: {
			type: require('./expansionprofileexcludedsystem.input'),
		...
		designation: {
			type: require('./expansionprofiledesignation.input'),
