...
/**
 * @name exports
 * @summary PlanDefinition Input Schema
 */
module.exports = new GraphQLInputObjectType({
	name: 'PlanDefinition_Input',
	description: 'Base StructureDefinition for PlanDefinition Resource.',
	fields: () =>
		extendSchema(require('./domainresource.input'), {
			resourceType: {
				type: new GraphQLNonNull(PlanDefinitionResourceInputType),
			...
			goal: {
				type: new GraphQLList(require('./plandefinitiongoal.input')),
				description:
					'Goals that describe what the activities within the plan are intended to achieve. For example, weight loss, restoring an activity of daily living, obtaining herd immunity via immunization, meeting a process improvement objective, etc.',
			},
			action: {
				type: new GraphQLList(require('./plandefinitionaction.input')),
