const { GraphQLInputObjectType, GraphQLNonNull, GraphQLString, GraphQLInt, GraphQLList } = require('graphql');
...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => extendSchema(require('./backboneelement.input'), {
		...
		target: {
			type: new GraphQLList(new GraphQLNonNull(require('./graphdefinitionlinktarget.input'))),
