...
let CompartmentDefinitionResourceInputType = new GraphQLEnumType({
	name: 'CompartmentDefinitionResourceInputType',
	values: {
...
module.exports = new GraphQLInputObjectType({
	...
	fields: () => extendSchema(require('./domainresource.input'), {
		resourceType: {
			type: new GraphQLNonNull(CompartmentDefinitionResourceInputType),
		...
		resource: {
			type: new GraphQLList(require('./compartmentdefinitionresource.input')),
