	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'EligibilityResponse_Enum_input',
		...
		insurance: {
			type: new GraphQLList(require('./eligibilityresponseinsurance.input.js')),
			description:
		...
		error: {
			type: new GraphQLList(require('./eligibilityresponseerror.input.js')),
