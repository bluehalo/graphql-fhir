...
let ActivityDefinitionResourceType = new GraphQLEnumType({
	name: 'ActivityDefinitionResourceType',
	values: {
...
module.exports = new GraphQLObjectType({
	...
	fields: () =>
		extendSchema(require('./domainresource.schema'), {
			resourceType: {
				type: new GraphQLNonNull(ActivityDefinitionResourceType),
			...
			participant: {
				type: new GraphQLList(
					require('./activitydefinitionparticipant.schema'),
				),
				description:
			...
			dynamicValue: {
				type: new GraphQLList(
					require('./activitydefinitiondynamicvalue.schema'),
				),
				description:
