	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'EligibilityResponse_Enum_schema',
		...
		requestProvider: {
			type: new GraphQLUnionType({
				name: 'EligibilityResponserequestProvider_requestProvider_Union',
				description:
		...
		request: {
			type: new GraphQLUnionType({
				name: 'EligibilityResponserequest_request_Union',
				description: 'Original request resource reference.',
				types: () => [require('./eligibilityrequest.schema.js')],
				resolveType(data) {
		...
		insurer: {
			type: new GraphQLUnionType({
				name: 'EligibilityResponseinsurer_insurer_Union',
		...
		insurance: {
			type: new GraphQLList(
				require('./eligibilityresponseinsurance.schema.js'),
			),
			description:
		...
		error: {
			type: new GraphQLList(require('./eligibilityresponseerror.schema.js')),
