...
module.exports = new GraphQLObjectType({
	...
	fields: () => extendSchema(require('./domainresource.schema'), {
		resourceType: {
			type: new GraphQLNonNull(CapabilityStatementResourceType),
		...
		software: {
			type: require('./capabilitystatementsoftware.schema'),
		...
		implementation: {
			type: require('./capabilitystatementimplementation.schema'),
		...
		rest: {
			type: new GraphQLList(require('./capabilitystatementrest.schema')),
			description: 'A definition of the restful capabilities of the solution, if any.'
		},
		messaging: {
			type: new GraphQLList(require('./capabilitystatementmessaging.schema')),
			description: 'A description of the messaging capabilities of the solution.'
		},
		document: {
			type: new GraphQLList(require('./capabilitystatementdocument.schema')),
