...
/**
 * @name exports
 * @summary CapabilityStatement Schema
 */
	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'CapabilityStatement_Enum_schema',
		...
		software: {
			type: require('./capabilitystatementsoftware.schema.js'),
			description:
				'Software that is covered by this capability statement.  It is used when the capability statement describes the capabilities of a particular software version, independent of an installation.',
		},
		implementation: {
			type: require('./capabilitystatementimplementation.schema.js'),
			description:
		...
		profile: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'CapabilityStatementprofile_profile_Union',
					description:
		...
		rest: {
			type: new GraphQLList(require('./capabilitystatementrest.schema.js')),
			description:
				'A definition of the restful capabilities of the solution, if any.',
		},
		messaging: {
			type: new GraphQLList(
				require('./capabilitystatementmessaging.schema.js'),
			),
			description:
				'A description of the messaging capabilities of the solution.',
		},
		document: {
			type: new GraphQLList(require('./capabilitystatementdocument.schema.js')),
