	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					...
					values: { PractitionerRole: { value: 'PractitionerRole' } },
				}),
			),
		...
		practitioner: {
			type: new GraphQLUnionType({
				name: 'PractitionerRolepractitioner_practitioner_Union',
				description:
		...
		organization: {
			type: new GraphQLUnionType({
				name: 'PractitionerRoleorganization_organization_Union',
				description:
		...
		location: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'PractitionerRolelocation_location_Union',
					description:
		...
		healthcareService: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'PractitionerRolehealthcareService_healthcareService_Union',
					description:
		...
		availableTime: {
			type: new GraphQLList(
				require('./practitionerroleavailabletime.schema.js'),
			),
			description: 'A collection of times that the Service Site is available.',
		},
		notAvailable: {
			type: new GraphQLList(
				require('./practitionerrolenotavailable.schema.js'),
			),
			description:
		...
		endpoint: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'PractitionerRoleendpoint_endpoint_Union',
					description:
