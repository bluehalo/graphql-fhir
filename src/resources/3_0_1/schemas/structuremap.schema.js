...
let StructureMapResourceType = new GraphQLEnumType({
	name: 'StructureMapResourceType',
	values: {
...
module.exports = new GraphQLObjectType({
	...
	fields: () => extendSchema(require('./domainresource.schema'), {
		resourceType: {
			type: new GraphQLNonNull(StructureMapResourceType),
		...
		structure: {
			type: new GraphQLList(require('./structuremapstructure.schema')),
		...
		group: {
			type: new GraphQLList(new GraphQLNonNull(require('./structuremapgroup.schema'))),
