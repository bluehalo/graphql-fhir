	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'StructureMap_Enum_schema',
					values: { StructureMap: { value: 'StructureMap' } },
				}),
			),
		...
		structure: {
			type: new GraphQLList(require('./structuremapstructure.schema.js')),
			description:
		...
		group: {
			type: new GraphQLList(
				new GraphQLNonNull(require('./structuremapgroup.schema.js')),
			),
			description:
