		...
		extendSchema(require('./domainresource.schema'), {
			...
			information: {
				type: new GraphQLList(
					require('./explanationofbenefitinformation.schema'),
				),
				description:
			...
			diagnosis: {
				type: new GraphQLList(
					require('./explanationofbenefitdiagnosis.schema'),
				),
				description:
			...
			procedure: {
				type: new GraphQLList(
					require('./explanationofbenefitprocedure.schema'),
				),
				description:
			...
			processNote: {
				type: new GraphQLList(
					require('./explanationofbenefitprocessnote.schema'),
				),
				description: 'Note text.',
			},
			benefitBalance: {
				type: new GraphQLList(
					require('./explanationofbenefitbenefitbalance.schema'),
				),
