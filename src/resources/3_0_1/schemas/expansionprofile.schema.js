	...
	fields: () => ({
		resourceType: {
			type: new GraphQLNonNull(
				new GraphQLEnumType({
					name: 'ExpansionProfile_Enum_schema',
		...
		fixedVersion: {
			type: new GraphQLList(
				require('./expansionprofilefixedversion.schema.js'),
			),
			description:
				'Fix use of a particular code system to a particular version.',
		},
		excludedSystem: {
			type: require('./expansionprofileexcludedsystem.schema.js'),
			description:
		...
		designation: {
			type: require('./expansionprofiledesignation.schema.js'),
			description:
