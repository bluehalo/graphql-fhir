	...
	fields: () => ({
		...
		measure: {
			type: new GraphQLNonNull(
				new GraphQLUnionType({
					name: 'MeasureReportmeasure_measure_Union',
					description:
						'A reference to the Measure that was evaluated to produce this report.',
					types: () => [require('./measure.schema.js')],
					resolveType(data) {
		...
		patient: {
			type: new GraphQLUnionType({
				name: 'MeasureReportpatient_patient_Union',
				description:
		...
		reportingOrganization: {
			type: new GraphQLUnionType({
				name: 'MeasureReportreportingOrganization_reportingOrganization_Union',
