	...
	fields: () => ({
		...
		source: {
			type: new GraphQLUnionType({
				name: 'DeviceMetricsource_source_Union',
				description:
		...
		parent: {
			type: new GraphQLUnionType({
				name: 'DeviceMetricparent_parent_Union',
				description:
		...
		calibration: {
			type: new GraphQLList(require('./devicemetriccalibration.schema.js')),
			description:
