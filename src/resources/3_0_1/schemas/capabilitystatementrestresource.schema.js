...
/**
 * @name exports
 * @summary CapabilityStatement.rest.resource Schema
 */
		...
		extendSchema(require('./backboneelement.schema'), {
			...
			interaction: {
				type: new GraphQLList(
					new GraphQLNonNull(
						require('./capabilitystatementrestresourceinteraction.schema'),
					),
				),
				description:
			...
			searchParam: {
				type: new GraphQLList(
					require('./capabilitystatementrestresourcesearchparam.schema'),
				),
				description:
