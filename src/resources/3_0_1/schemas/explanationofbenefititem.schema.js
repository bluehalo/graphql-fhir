	...
	fields: () => ({
		...
		locationReference: {
			type: new GraphQLUnionType({
				name: 'ExplanationOfBenefititemlocationReference_locationReference_Union',
				description: 'Where the service was provided.',
		...
		udi: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'ExplanationOfBenefititemudi_udi_Union',
					description:
		...
		encounter: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'ExplanationOfBenefititemencounter_encounter_Union',
					description:
		...
		adjudication: {
			type: new GraphQLList(
				require('./explanationofbenefititemadjudication.schema.js'),
			),
			description: 'The adjudications results.',
		},
		detail: {
			type: new GraphQLList(
				require('./explanationofbenefititemdetail.schema.js'),
			),
