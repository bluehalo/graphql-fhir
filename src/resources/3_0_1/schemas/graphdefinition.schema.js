...
let GraphDefinitionResourceType = new GraphQLEnumType({
	name: 'GraphDefinitionResourceType',
	values: {
...
/**
 * @name exports
 * @summary GraphDefinition Schema
 */
module.exports = new GraphQLObjectType({
	...
	fields: () => extendSchema(require('./domainresource.schema'), {
		resourceType: {
			type: new GraphQLNonNull(GraphDefinitionResourceType),
		...
		link: {
			type: new GraphQLList(require('./graphdefinitionlink.schema')),
