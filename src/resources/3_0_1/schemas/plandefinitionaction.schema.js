...
/**
 * @name exports
 * @summary PlanDefinition.action Schema
 */
		...
		extendSchema(require('./backboneelement.schema'), {
			...
			condition: {
				type: new GraphQLList(
					require('./plandefinitionactioncondition.schema'),
				),
				description:
			...
			relatedAction: {
				type: new GraphQLList(
					require('./plandefinitionactionrelatedaction.schema'),
				),
				description:
			...
			participant: {
				type: new GraphQLList(
					require('./plandefinitionactionparticipant.schema'),
				),
				description:
			...
			dynamicValue: {
				type: new GraphQLList(
					require('./plandefinitionactiondynamicvalue.schema'),
				),
				description:
