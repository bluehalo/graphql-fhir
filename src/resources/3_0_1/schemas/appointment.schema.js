...
module.exports = new GraphQLObjectType({
	...
	fields: () => ({
		...
		indication: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'Appointmentindication_indication_Union',
					description:
		...
		supportingInformation: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'AppointmentsupportingInformation_supportingInformation_Union',
					description:
		...
		slot: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'Appointmentslot_slot_Union',
					description:
						"The slots from the participants' schedules that will be filled by the appointment.",
					types: () => [require('./slot.schema.js')],
					resolveType(data) {
		...
		incomingReferral: {
			type: new GraphQLList(
				new GraphQLUnionType({
					name: 'AppointmentincomingReferral_incomingReferral_Union',
					description:
		...
		participant: {
			type: new GraphQLList(
				new GraphQLNonNull(require('./appointmentparticipant.schema.js')),
			),
