...
module.exports = {
	identifier: {
		type: TokenScalar,
		description:
			'Unique Identifier for the set of documents (See http://hl7.org/fhir/SearchParameter/clinical-identifier).',
	},
	related_id: {
		type: TokenScalar,
		description:
	...
	type: {
		type: TokenScalar,
		description:
			'Kind of document set (See http://hl7.org/fhir/SearchParameter/clinical-type).',
	},
	related_ref: {
		type: GraphQLString,
		description:
	...
	patient: {
		type: GraphQLString,
		description:
			'The subject of the set of documents (See http://hl7.org/fhir/SearchParameter/clinical-patient).',
	},
	recipient: {
		type: GraphQLString,
		description:
