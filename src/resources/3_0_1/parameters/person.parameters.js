...
module.exports = {
	...
	birthdate: {
		type: DateScalar,
		description: 'The person\'s date of birth (See http://hl7.org/fhir/SearchParameter/individual-birthdate).'
	},
	address_state: {
		type: GraphQLString,
	...
	gender: {
		type: TokenScalar,
		description: 'The gender of the person (See http://hl7.org/fhir/SearchParameter/individual-gender).'
	},
	practitioner: {
		type: GraphQLString,
	...
	name: {
		type: GraphQLString,
		description: 'A server defined search that may match any of the string fields in the HumanName, including family, give, prefix, suffix, suffix, and/or text (See http://hl7.org/fhir/SearchParameter/Person-name).'
	},
	address_use: {
		type: TokenScalar,
