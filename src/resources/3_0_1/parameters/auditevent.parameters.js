...
module.exports = {
	...
	entity_type: {
		type: TokenScalar,
		description: 'Type of entity involved. See http://hl7.org/fhir/SearchParameter/AuditEvent-entity-type.'
	},
	agent: {
		type: GraphQLString,
		description: 'Direct reference to resource. See http://hl7.org/fhir/SearchParameter/AuditEvent-agent.'
	},
	address: {
		type: GraphQLString,
	...
	entity_role: {
		type: TokenScalar,
		description: 'What role the entity played. See http://hl7.org/fhir/SearchParameter/AuditEvent-entity-role.'
	},
	source: {
		type: TokenScalar,
	...
	agent_name: {
		type: GraphQLString,
		description: 'Human-meaningful name for the agent. See http://hl7.org/fhir/SearchParameter/AuditEvent-agent-name.'
	},
	entity_name: {
		type: GraphQLString,
		description: 'Descriptor for entity. See http://hl7.org/fhir/SearchParameter/AuditEvent-entity-name.'
	},
	subtype: {
		type: TokenScalar,
	...
	agent_role: {
		type: TokenScalar,
		description: 'Agent role in the event. See http://hl7.org/fhir/SearchParameter/AuditEvent-agent-role.'
	},
	user: {
		type: TokenScalar,
	...
	entity: {
		type: GraphQLString,
		description: 'Specific instance of resource. See http://hl7.org/fhir/SearchParameter/AuditEvent-entity.'
	},
	entity_id: {
		type: TokenScalar,
		description: 'Specific instance of object. See http://hl7.org/fhir/SearchParameter/AuditEvent-entity-id.'
	},
	outcome: {
		type: TokenScalar,
		description: 'Whether the event succeeded or failed. See http://hl7.org/fhir/SearchParameter/AuditEvent-outcome.'
	},
	policy: {
		type: UriScalar,
