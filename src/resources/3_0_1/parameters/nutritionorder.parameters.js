...
module.exports = {
	identifier: {
		type: TokenScalar,
		description:
			'Return nutrition orders with this external identifier (See http://hl7.org/fhir/SearchParameter/clinical-identifier).',
	},
	datetime: {
		type: DateScalar,
		description:
	...
	patient: {
		type: GraphQLString,
		description:
			'The identity of the person who requires the diet, formula or nutritional supplement (See http://hl7.org/fhir/SearchParameter/clinical-patient).',
	},
	supplement: {
		type: TokenScalar,
		description:
	...
	encounter: {
		type: GraphQLString,
		description:
			'Return nutrition orders with this encounter identifier (See http://hl7.org/fhir/SearchParameter/clinical-encounter).',
	},
	oraldiet: {
		type: TokenScalar,
		description:
