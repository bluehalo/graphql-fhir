...
module.exports = {
	...
	code: {
		type: TokenScalar,
		description:
			'The code of the substance or ingredient (See http://hl7.org/fhir/SearchParameter/Substance-code).',
	},
	quantity: {
		type: GraphQLString,
		description:
	...
	substance_reference: {
		type: GraphQLString,
		description:
			'A component of the substance (See http://hl7.org/fhir/SearchParameter/Substance-substance-reference).',
	},
	expiry: {
		type: DateScalar,
		description:
	...
	status: {
		type: TokenScalar,
		description:
			'active | inactive | entered-in-error (See http://hl7.org/fhir/SearchParameter/Substance-status).',
	},
};
