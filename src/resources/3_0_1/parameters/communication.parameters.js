...
module.exports = {
	...
	part_of: {
		type: GraphQLString,
		description:
			'Part of this action (See http://hl7.org/fhir/SearchParameter/Communication-part-of).',
	},
	medium: {
		type: TokenScalar,
		description:
	...
	based_on: {
		type: GraphQLString,
		description:
			'Request fulfilled by this communication (See http://hl7.org/fhir/SearchParameter/Communication-based-on).',
	},
	sender: {
		type: GraphQLString,
		description:
	...
	context: {
		type: GraphQLString,
		description:
			'Encounter or episode leading to message (See http://hl7.org/fhir/SearchParameter/Communication-context).',
	},
	definition: {
		type: GraphQLString,
		description:
			'Instantiates protocol or definition (See http://hl7.org/fhir/SearchParameter/Communication-definition).',
	},
	category: {
		type: TokenScalar,
		description:
	...
	status: {
		type: TokenScalar,
		description:
			'preparation | in-progress | suspended | aborted | completed | entered-in-error (See http://hl7.org/fhir/SearchParameter/Communication-status).',
	},
};
