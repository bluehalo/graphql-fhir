...
module.exports = {
	date: {
		type: DateScalar,
		description:
			'Vaccination  (non)-Administration Date (See http://hl7.org/fhir/SearchParameter/clinical-date).',
	},
	identifier: {
		type: TokenScalar,
		description:
	...
	practitioner: {
		type: GraphQLString,
		description:
			'The practitioner who played a role in the vaccination (See http://hl7.org/fhir/SearchParameter/Immunization-practitioner).',
	},
	notgiven: {
		type: TokenScalar,
		description:
	...
	patient: {
		type: GraphQLString,
		description:
			'The patient for the vaccination record (See http://hl7.org/fhir/SearchParameter/clinical-patient).',
	},
	vaccine_code: {
		type: TokenScalar,
		description:
