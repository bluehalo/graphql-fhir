...
module.exports = {
	...
	focus: {
		type: GraphQLString,
		description:
			'The actual content of the message (See http://hl7.org/fhir/SearchParameter/MessageHeader-focus).',
	},
	source: {
		type: GraphQLString,
		description:
	...
	sender: {
		type: GraphQLString,
		description:
			'Real world sender of the message (See http://hl7.org/fhir/SearchParameter/MessageHeader-sender).',
	},
	responsible: {
		type: GraphQLString,
		description:
