...
module.exports = {
	...
	animal_breed: {
		type: TokenScalar,
		description: 'The breed of animal for patients. See http://hl7.org/fhir/SearchParameter/Patient-animal-breed'
	},
	address_country: {
		type: GraphQLString,
		description: 'A country specified in the address. See http://hl7.org/fhir/SearchParameter/individual-address-country'
	},
	death_date: {
		type: DateScalar,
	...
	phonetic: {
		type: GraphQLString,
		description: 'A portion of either family or given name using some kind of phonetic matching algortihm. See http://hl7.org/fhir/SearchParameter/individual-phonetic'
	},
	telecom: {
		type: TokenScalar,
	...
	address_city: {
		type: GraphQLString,
		description: 'A city specified in the address. See http://hl7.org/fhir/SearchParameter/individual-address-city'
	},
	email: {
		type: TokenScalar,
	...
	given: {
		type: GraphQLString,
		description: 'A portion of the name of the patient. See http://hl7.org/fhir/SearchParameter/individual-given'
	},
	address: {
		type: GraphQLString,
		description: 'A server defined search term that may match any of the string fields in the Address, including line, city, state, country, postalCode, and/or text. See http://hl7.org/fhir/SearchParameter/individual-address'
	},
	...
	address_postalcode: {
		type: GraphQLString,
		description: 'A postalCode specified in the address. See http://hl7.org/fhir/SearchParameter/individual-address-postalcode'
	},
	phone: {
		type: TokenScalar,
		description: 'A value in the phone contact. See http://hl7.org/fhir/SearchParameter/individual-phone'
	},
	organization: {
		type: GraphQLString,
	...
	name: {
		type: GraphQLString,
		description: 'A server defined search that may match any of the string fields in HumanName, including famliy, given, prefix, suffix, and/or text. See http://hl7.org/fhir/SearchParameter/Patient-name'
	},
	address_use: {
		type: GraphQLString,
		description: 'A use code specified in the address. See http://hl7.org/fhir/SearchParameter/individual-address-use'
	},
	family: {
		type: GraphQLString,
		description: 'A portion of the famliy name of the patient. See http://hl7.org/fhir/SearchParameter/individual-family'
	}
};
