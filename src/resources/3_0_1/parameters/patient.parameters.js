...
module.exports = {
	birthdate: {
		type: DateScalar,
		description:
			"The patient's date of birth (See http://hl7.org/fhir/SearchParameter/individual-birthdate).",
	},
	deceased: {
		type: TokenScalar,
		description:
	...
	gender: {
		type: TokenScalar,
		description:
			'Gender of the patient (See http://hl7.org/fhir/SearchParameter/individual-gender).',
	},
	animal_species: {
		type: TokenScalar,
		description:
	...
	death_date: {
		type: DateScalar,
		description:
			'The date of death has been provided and satisfies this search value (See http://hl7.org/fhir/SearchParameter/Patient-death-date).',
	},
	phonetic: {
		type: GraphQLString,
		description:
			'A portion of either family or given name using some kind of phonetic matching algorithm (See http://hl7.org/fhir/SearchParameter/individual-phonetic).',
	},
	telecom: {
		type: TokenScalar,
		description:
			'The value in any kind of telecom details of the patient (See http://hl7.org/fhir/SearchParameter/individual-telecom).',
	},
	address_city: {
		type: GraphQLString,
		description:
	...
	given: {
		type: GraphQLString,
		description:
			'A portion of the given name of the patient (See http://hl7.org/fhir/SearchParameter/individual-given).',
	},
	address: {
		type: GraphQLString,
		description:
	...
	general_practitioner: {
		type: GraphQLString,
		description:
			"Patient's nominated general practitioner, not the organization that manages the record (See http://hl7.org/fhir/SearchParameter/Patient-general-practitioner).",
	},
	active: {
		type: TokenScalar,
		description:
	...
	address_postalcode: {
		type: GraphQLString,
		description:
			'A postalCode specified in an address (See http://hl7.org/fhir/SearchParameter/individual-address-postalcode).',
	},
	phone: {
		type: TokenScalar,
		description:
	...
	name: {
		type: GraphQLString,
		description:
			'A server defined search that may match any of the string fields in the HumanName, including family, give, prefix, suffix, suffix, and/or text (See http://hl7.org/fhir/SearchParameter/Patient-name).',
	},
	address_use: {
		type: TokenScalar,
		description:
	...
	family: {
		type: GraphQLString,
		description:
			'A portion of the family name of the patient (See http://hl7.org/fhir/SearchParameter/individual-family).',
	},
};
