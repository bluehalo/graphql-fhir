...
module.exports = {
	...
	partof: {
		type: GraphQLString,
		description:
			'An organization of which this organization forms a part (See http://hl7.org/fhir/SearchParameter/Organization-partof).',
	},
	address: {
		type: GraphQLString,
		description:
	...
	active: {
		type: TokenScalar,
		description:
			'A server defined search that may match any of the string fields in the Address, including line, city, state, country, postalCode, and/or text (See http://hl7.org/fhir/SearchParameter/Organization-active).',
	},
	type: {
		type: TokenScalar,
		description:
	...
	endpoint: {
		type: GraphQLString,
		description:
			'Technical endpoints providing access to services operated for the organization (See http://hl7.org/fhir/SearchParameter/Organization-endpoint).',
	},
	phonetic: {
		type: GraphQLString,
		description:
	...
	name: {
		type: GraphQLString,
		description:
			"A portion of the organization's name or alias (See http://hl7.org/fhir/SearchParameter/Organization-name).",
	},
	address_use: {
		type: TokenScalar,
		description:
