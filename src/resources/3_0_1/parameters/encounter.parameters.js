...
module.exports = {
	date: {
		type: DateScalar,
		description:
			'A date within the period the Encounter lasted (See http://hl7.org/fhir/SearchParameter/clinical-date).',
	},
	identifier: {
		type: TokenScalar,
		description:
			'Identifier(s) by which this encounter is known (See http://hl7.org/fhir/SearchParameter/clinical-identifier).',
	},
	reason: {
		type: TokenScalar,
		description:
	...
	subject: {
		type: GraphQLString,
		description:
			'The patient ro group present at the encounter (See http://hl7.org/fhir/SearchParameter/Encounter-subject).',
	},
	length: {
		type: GraphQLString,
		description:
	...
	diagnosis: {
		type: GraphQLString,
		description:
			'Reason the encounter takes place (resource) (See http://hl7.org/fhir/SearchParameter/Encounter-diagnosis).',
	},
	appointment: {
		type: GraphQLString,
		description:
	...
	type: {
		type: TokenScalar,
		description:
			'Specific type of encounter (See http://hl7.org/fhir/SearchParameter/clinical-type).',
	},
	participant: {
		type: GraphQLString,
		description:
	...
	patient: {
		type: GraphQLString,
		description:
			'The patient ro group present at the encounter (See http://hl7.org/fhir/SearchParameter/clinical-patient).',
	},
	location_period: {
		type: DateScalar,
		description:
	...
	service_provider: {
		type: GraphQLString,
		description:
			'The custodian organization of this Encounter record (See http://hl7.org/fhir/SearchParameter/Encounter-service-provider).',
	},
	special_arrangement: {
		type: TokenScalar,
		description:
	...
	class: {
		type: TokenScalar,
		description:
			'inpatient | outpatient | ambulatory | emergency + (See http://hl7.org/fhir/SearchParameter/Encounter-class).',
	},
	status: {
		type: TokenScalar,
		description:
			'planned | arrived | triaged | in-progress | onleave | finished | cancelled + (See http://hl7.org/fhir/SearchParameter/Encounter-status).',
	},
};
