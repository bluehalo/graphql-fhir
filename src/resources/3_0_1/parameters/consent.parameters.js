...
module.exports = {
	...
	// http://hl7.org/fhir/SearchParameter/Consent-consentor
	consentor: {
		type: GraphQLString,
		fhirtype: 'reference',
	...
	// http://hl7.org/fhir/SearchParameter/Consent-organization
	organization: {
		type: GraphQLString,
		fhirtype: 'reference',
	...
	// http://hl7.org/fhir/SearchParameter/Consent-securitylabel
	securitylabel: {
		type: TokenScalar,
		fhirtype: 'token',
	...
	// http://hl7.org/fhir/SearchParameter/Consent-source
	source: {
		type: GraphQLString,
		fhirtype: 'reference',
