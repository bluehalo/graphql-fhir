...
module.exports = {
	...
	incomingreferral: {
		type: GraphQLString,
		description:
			'The ReferralRequest provided as information to allocate to the Encounter (See http://hl7.org/fhir/SearchParameter/Appointment-incomingreferral).',
	},
	part_status: {
		type: TokenScalar,
		description:
	...
	appointment_type: {
		type: TokenScalar,
		description:
			'The style of appointment or patient that has been booked in the slot (not service type) (See http://hl7.org/fhir/SearchParameter/Appointment-appointment-type).',
	},
	service_type: {
		type: TokenScalar,
		description:
			'The specific service that is to be performed during this appointment (See http://hl7.org/fhir/SearchParameter/Appointment-service-type).',
	},
	location: {
		type: GraphQLString,
		description:
