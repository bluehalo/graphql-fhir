...
module.exports = {
	...
	type: {
		type: TokenScalar,
		description: 'Kind of document (LOINC if possible). See http://hl7.org/fhir/SearchParameter/clinical-type.'
	},
	relation: {
		type: TokenScalar,
	...
	patient: {
		type: GraphQLString,
		description: 'Who/what is the subject of the document. See http://hl7.org/fhir/SearchParameter/clinical-patient.'
	},
	relationship: {
		type: GraphQLString,
	...
	identifier: {
		type: TokenScalar,
		description: 'Master Version Specific Identifier. See http://hl7.org/fhir/SearchParameter/clinical-identifier.'
	},
	period: {
		type: DateScalar,
	...
	indexed: {
		type: DateScalar,
		description: 'When this document reference was created. See http://hl7.org/fhir/SearchParameter/DocumentReference-indexed.'
	},
	author: {
		type: GraphQLString,
	...
	encounter: {
		type: GraphQLString,
		description: 'Context of the document  content. See http://hl7.org/fhir/SearchParameter/clinical-encounter.'
	},
	related_ref: {
		type: GraphQLString,
