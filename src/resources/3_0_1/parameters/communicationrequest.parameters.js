...
module.exports = {
	requester: {
		type: GraphQLString,
		description: 'Individual making the request. See http://hl7.org/fhir/SearchParameter/CommunicationRequest-requester.'
	},
	authored: {
		type: DateScalar,
		description: 'When request transitioned to being actionable. See http://hl7.org/fhir/SearchParameter/CommunicationRequest-authored.'
	},
	identifier: {
		type: TokenScalar,
	...
	replaces: {
		type: GraphQLString,
		description: 'Request(s) replaced by this request. See http://hl7.org/fhir/SearchParameter/CommunicationRequest-replaces.'
	},
	medium: {
		type: TokenScalar,
	...
	occurrence: {
		type: DateScalar,
		description: 'When scheduled. See http://hl7.org/fhir/SearchParameter/CommunicationRequest-occurrence.'
	},
	encounter: {
		type: GraphQLString,
	...
	group_identifier: {
		type: TokenScalar,
		description: 'Composite request this is part of. See http://hl7.org/fhir/SearchParameter/CommunicationRequest-group-identifier.'
	},
	based_on: {
		type: GraphQLString,
		description: 'Fulfills plan or proposal. See http://hl7.org/fhir/SearchParameter/CommunicationRequest-based-on.'
	},
	sender: {
		type: GraphQLString,
	...
	context: {
		type: GraphQLString,
		description: 'Encounter or episode leading to message. See http://hl7.org/fhir/SearchParameter/CommunicationRequest-context.'
	},
	category: {
		type: TokenScalar,
	...
	status: {
		type: TokenScalar,
		description: 'draft | active | suspended | cancelled | completed | entered-in-error | unknown. See http://hl7.org/fhir/SearchParameter/CommunicationRequest-status.'
	}
};
