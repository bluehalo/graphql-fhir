...
module.exports = {
	entity_ref: {
		type: GraphQLString,
		description:
			'Identity of entity (See http://hl7.org/fhir/SearchParameter/Provenance-entity-ref).',
	},
	agent: {
		type: GraphQLString,
		description:
			'Who participated (See http://hl7.org/fhir/SearchParameter/Provenance-agent).',
	},
	signature_type: {
		type: TokenScalar,
		description:
			'Indication of the reason the entity signed the object(s) (See http://hl7.org/fhir/SearchParameter/Provenance-signature-type).',
	},
	patient: {
		type: GraphQLString,
		description:
	...
	recorded: {
		type: DateScalar,
		description:
			'When the activity was recorded / updated (See http://hl7.org/fhir/SearchParameter/Provenance-recorded).',
	},
	agent_role: {
		type: TokenScalar,
		description:
			'What the agents role was (See http://hl7.org/fhir/SearchParameter/Provenance-agent-role).',
	},
	entity_id: {
		type: TokenScalar,
		description:
			'Identity of entity (See http://hl7.org/fhir/SearchParameter/Provenance-entity-id).',
	},
	target: {
		type: GraphQLString,
		description:
