...
module.exports = {
	date: {
		type: DateScalar,
		description: 'When Media was collected (See http://hl7.org/fhir/SearchParameter/Media-date).'
	},
	identifier: {
		type: TokenScalar,
	...
	site: {
		type: TokenScalar,
		description: 'Body part in media (See http://hl7.org/fhir/SearchParameter/Media-site).'
	},
	based_on: {
		type: GraphQLString,
		description: 'Procedure that caused this media to be created (See http://hl7.org/fhir/SearchParameter/Media-based-on).'
	},
	subtype: {
		type: TokenScalar,
	...
	context: {
		type: GraphQLString,
		description: 'Encounter / Episode associated with media (See http://hl7.org/fhir/SearchParameter/Media-context).'
	},
	device: {
		type: GraphQLString,
		description: 'Observing Device (See http://hl7.org/fhir/SearchParameter/Media-device).'
	}
};
